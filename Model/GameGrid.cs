...
namespace Match3.Model
{
    public class GameGrid
    {
        ...
        public Figure GetFigure(Vector2 position) => _figures[position.X, position.Y];
        ...
        private bool ExecuteMatch(Vector2 position, ref Figure firstFigure)
        {
        ...
        private bool TrySetBonus(List<Figure> match, ref Figure figureToSet)
        {
